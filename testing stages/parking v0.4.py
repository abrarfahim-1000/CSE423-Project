...
# Update acceleration based on keys instead of key press events
def update_car_position():
    """Updates the car position based on current speed and direction"""
    global player_pos, player_angle, speed, keys_pressed
...
def keyboard_listener(key, x, y):
    global player_pos, player_angle, camera_mode, speed, car_model, car_color, game_over, keys_pressed
